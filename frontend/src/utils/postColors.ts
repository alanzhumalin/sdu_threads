export const POST_CONTAINER_COLOR_OPTIONS = [
  {
    ...
    cardClass:
      "!border-cyan-300/55 !bg-gradient-to-br !from-cyan-500/30 !to-blue-500/24",
  },
  {
    key: "rose",
    label: "Rose",
    ...
    cardClass:
      "!border-rose-300/55 !bg-gradient-to-br !from-rose-500/30 !to-pink-500/24",
  },
  {
    key: "emerald",
    label: "Emerald",
    ...
    cardClass:
      "!border-emerald-300/55 !bg-gradient-to-br !from-emerald-500/30 !to-teal-500/24",
  },
  {
    key: "amber",
    label: "Amber",
    ...
    cardClass:
      "!border-amber-300/55 !bg-gradient-to-br !from-amber-500/30 !to-orange-500/24",
  },
  {
    key: "violet",
    label: "Violet",
    ...
    cardClass:
      "!border-indigo-300/55 !bg-gradient-to-br !from-indigo-500/30 !to-violet-500/24",
  },
] as const;
