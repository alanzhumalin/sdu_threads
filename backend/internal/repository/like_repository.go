...
func (r *LikeRepository) Add(ctx context.Context, postID, userID string) error {
...
func (r *LikeRepository) AddComment(ctx context.Context, commentID, userID string) error {
...
func (r *LikeRepository) RemoveComment(ctx context.Context, commentID, userID string) error {
	return r.db.WithContext(ctx).
		Exec(`DELETE FROM comment_likes WHERE comment_id = ? AND user_id = ?`, commentID, userID).Error
}

func (r *LikeRepository) CommentLikedBy(ctx context.Context, commentID, userID string) (bool, error) {
	var exists bool
...
func (r *LikeRepository) Remove(ctx context.Context, postID, userID string) error {
	return r.db.WithContext(ctx).
...
func (r *LikeRepository) IsLiked(ctx context.Context, postID, userID string) (bool, error) {
	var exists bool
	err := r.db.WithContext(ctx).
